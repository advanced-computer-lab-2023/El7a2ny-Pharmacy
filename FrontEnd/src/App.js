  ...
  const routes = createHashRouter([
    {
      ...
      children:[
        ...
        {path : "AdminOtpLogin",element:<AdminOtpLogin saveAdminData={saveAdminData}/>},
        ...
        {path : "PatientOtpLogin",element:<PatientOtpLogin savePatientData={savePatientData}/>},
        ...
        {path : "PharmacistOtpLogin",element:<PharmacistOtpLogin savePharmacistData={savePharmacistData}/>},
